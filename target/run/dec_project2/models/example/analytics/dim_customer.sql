  ...
  create or replace view `my-second-project-422312`.`my_dataset_yay`.`dim_customer`
  OPTIONS()
  as WITH dim_customer__add_customer_souce AS (
    SELECT * 
    FROM `my-second-project-422312.my_dataset_yayy.stg_dim_customer`
)
...
,dim_product__add_store_souce AS (
    ...
    INNER JOIN `my-second-project-422312.my_dataset_yayy.stg_dim_store` sto
...
,dim_product__add_territory_souce AS (
    ...
    INNER JOIN `my-second-project-422312.my_dataset_yayy.stg_dim_salesterritory` ter
...
,dim_product__add_region_name AS (
    ...
    INNER JOIN `my-second-project-422312.my_dataset_yayy.stg_dim_region` reg
...
,dim_product__add_person_source AS (
    ...
    INNER JOIN `my-second-project-422312.my_dataset_yayy.stg_dim_person` per
