    ...
    create or replace table `my-second-project-422312`.`my_dataset_yayy`.`dim_product`
    ...
    OPTIONS()
    as (
      WITH dim_product__add_product_souce AS (
    SELECT * 
    FROM `my-second-project-422312.my_dataset_yayy_stg.stg_dim_product`
)
...
,dim_product__add_subcategory_souce AS (
    ...
    INNER JOIN `my-second-project-422312.my_dataset_yayy_stg.stg_dim_subcategory` sub
...
,dim_product__add_category_souce AS (
    ...
    INNER JOIN `my-second-project-422312.my_dataset_yayy_stg.stg_dim_category` cat
...
,dim_product__add_model_souce AS (
    ...
    INNER JOIN `my-second-project-422312.my_dataset_yayy_stg.stg_dim_model` mol
...
,dim_product__add_weight_name_souce AS (
    ...
    INNER JOIN `my-second-project-422312.my_dataset_yayy_stg.stg_dim_unitmeasure` uni
